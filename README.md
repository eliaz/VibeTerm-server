...
Please also note that the default mode is "yolo" which means the agent can perform any commands allowed by the privileges for the user that started the server instance. 
